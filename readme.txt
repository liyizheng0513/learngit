...
class MACD(technical_Analysis):
    ...
    def situation_define(self):
        ...
        """
        dif_d, dea_d, macd_d = talib.MACD(self.data_day.close.values)
        dif_w, dea_w, macd_w = talib.MACD(self.data_week.close.values)
        ...
        pct = list(self.data_day.close.pct_change().ix[situation.index].values)[1:]
        pct.append(0)
